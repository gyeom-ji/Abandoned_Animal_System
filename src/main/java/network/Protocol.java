...
public class Protocol {
    ...
    public static final int ENTITY_MISSING_NOTICE = 2;
    public static final int ENTITY_ABANDONED_ANIMAL_NOTICE = 3;
    public static final int ENTITY_SHELTER_LIST = 4;
    public static final int ENTITY_FORM = 5;
    public static final int ENTITY_FORM_APPROVAL = 6;
    public static final int ENTITY_ADMIN = 7;
    public static final int ENTITY_STAFF = 8;
    public static final int ENTITY_MEMBER = 9;
    public static final int ENTITY_MATERIALS = 10;
    public static final int ENTITY_VACCINE = 11;
    public static final int ENTITY_ANIMAL = 12;
    // UPDATE
    public static final int UPDATE_PASSWORD = 1;
    public static final int UPDATE_ROLL = 2;
    // header : READ_OPTION
