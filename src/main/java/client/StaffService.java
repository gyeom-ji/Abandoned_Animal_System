            ...
            if (recvPt.getType() == Protocol.TYPE_RESPONSE) {
                if (recvPt.getCode() == Protocol.T2_CODE_SUCCESS) {
                    ...
                    for (int i = 0; i < formDTO.length; i++) {
                        ...
                        System.out.println("roll_id : " + formDTO[i].getRollDTOList().get(0).getRoll_id());
                        System.out.println("roll_name : " + formDTO[i].getRollDTOList().get(0).getRoll_name());
                        System.out.println("roll_phone : " + formDTO[i].getRollDTOList().get(0).getRoll_phone());
                        System.out.println("roll_type : " + formDTO[i].getRollDTOList().get(0).getRoll_type());
                        System.out.println("shelter name : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_name());
                        System.out.println("shelter phone : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_phone());
                        System.out.println("shelter county : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_county());
                        System.out.println("shelter city : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_city());
                        System.out.println("shelter address : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_address());
                        System.out.println("shelter type : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_type());
                        System.out.println("shelter open time : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_open_time());
                        System.out.println("shelter close time : " + formDTO[i].getShelter_listDTOList().get(0).getShelter_close_time());
                        System.out.println("abandoned_notice_pk : " + formDTO[i].getAbandoned_notice_pk());
                        System.out.println("abandoned notice num : " + formDTO[i].getAbandonedNoticeDTOList().get(i).getAbandoned_notice_num());
                        System.out.println("abandoned notice receipt date : " + formDTO[i].getAbandonedNoticeDTOList().get(i).getAbandoned_receipt_date());
                        System.out.println("abandoned notice place : " + formDTO[i].getAbandonedNoticeDTOList().get(i).getAbandoned_place());
                    }
                } else if (recvPt.getCode() == Protocol.T2_CODE_FAIL)
                    System.out.println("정보가 없습니다.");
            }
