...
public interface IRecommend_materialsDAO {
    ...
    //추천상품 정보 수정
    @Update("update recommend_materials set materials_name = #{materials_name}, materials_type = #{materials_type}, " +
            "materials_url = #{materials_url}, materials_feature = #{materials_feature}, materials_img = " +
            "#{materials_img}, materials_form_pk = #{materials_form_pk}, materials_animal_kind = #{materials_animal_kind}, " +
            "materials_animal_breed = #{materials_animal_breed}, materials_animal_age = #{materials_animal_age} " +
    ...
    @ResultMap("recommend_materialsResultSet")
    Recommend_materialsDTO select(long shelter_list_pk);
}
